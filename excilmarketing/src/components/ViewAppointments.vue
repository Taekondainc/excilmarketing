<template
  ><div>
    <div class="crtapp">
      <div>
        <h1 class="banner15">Your Appointments</h1>
        <router-linkrticle>
    ...
    <div class="displayproductsaopp">
      <div class="extservdivapp"><div><h1>Your Appointments</h1></div>
    </div>  
      <div class="displaysaopp">
     
      <div v-for="event in calendarOptions.events" :key="event.id" class="justdiv">
           <div id="textprodapp"> 
              <div>Name of Entity: {{event.title }} </div> <div>Appointment Date: {{event.start }}</div> 
               
               <div>Entity Contact: {{event.number }}</div>  
               
               <div>Description: {{event.description}}</div>    </div> </div>  </div>  
  ...
  <li>save or press cancel to clear form</li>
     ...
     <!---   <div v-for="event in calendarOptions.events" :key="event.id">
        ...
        <div v-show="modalhidden">
         ...
         <div> <input type="text" name="" v-model="titled" id="appid"  placeholder="Name" /></div>
          <div> <input type="text" name="" v-model="numbers" id="appid" placeholder="Phone Number"  /></div>
           <div> <textarea name=""   v-model="descriptions" id="appid" cols="30" rows="10" placeholder="Description" ></textarea></div>
...
.creatapp2 {
  background-color:#f5b06fc0;color:  black !important;
  padding: 3rem;
  padding-left: 20px;
  padding-right: 20px;
  height: 100vh;
