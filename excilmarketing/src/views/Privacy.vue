  ...
  <div>
    <div id="coverpic2">
      <div>
        <img
          id="wpwallpaper2"
          src="https://res.cloudinary.com/excil-marketing/image/upload/v1605214161/excil/extAsset_1_yl0jby.png"
          alt=""
          srcset=""
        />
      </div>
      <h1>Privacy Policy</h1>
      <h3>Effective December, 1ST ,2020</h3>
      <div id="logocont">
        <router-link to="/">
          <img
    ...
    <div id="privacy">
      <h1>Privacy Policy</h1>
      <p>Last updated: November 12, 2020</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Excil Markerting, 112 blue berry hill
            Wismar linden.
          </p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Country</strong> refers to: Guyana</p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Excil Markerting, accessible from
            <router-link
              href="www.ExcilMarkerting.com"
              rel="external nofollow noopener"
              target="_blank"
              >www.ExcilMarkerting.com</a
            >
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: Operationexmarketing@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 592-668-8421</p>
        </li>
      </ul>
    </div>
  </div>
